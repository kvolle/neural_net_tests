...
class siamese:
    ...
    def custom_loss(self):
        loss = tf.losses.mean_squared_error(self.y_, self.o1)
        return loss

    def acc_summary(self):
        loss = tf.losses.mean_squared_error(self.y_, self.o1, reduction=tf.losses.Reduction.MEAN)
        return tf.summary.scalar("loss", loss)
"""
    def custom_loss(self):
        margin = 5.0
